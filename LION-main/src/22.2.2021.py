...
import INTERNAL.PYLION.modules as _modules

os.environ["LION_INSTALL_DIR"] = os.getcwd()


import t as _t


# _modules.modules ["testing"] = ["testing", "t.py", os.getcwd(),      {"example_function":_t.example_function}]

# print(_modules.modules)

_modules.LION_MODULE_HANDLER.__finish__()
...
global variables,toknum,functions, arrays, pointers
...
functions = ['write','if','var','roar',"input","int","string", "savedVar", "while","random","function", "savedVarDelete", "for", "system", "ptr","array","call","return", "memset", "extern", "import"]
keywords = ["//", "auto"]
variables = {}
saved_variables = {}
