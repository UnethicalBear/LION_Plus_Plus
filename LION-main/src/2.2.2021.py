    ...
    for i in range(len(text)):
      if text[i] == "{" and isString == False and isNum == False:
        ...
        if current_text_list.strip() != "":
          command_parts.append(Token(TO_RT, current_text_list, line = self.li))
          current_text_list = ""
        
        command_parts.append(Token(TO_LCBRACKET, text[i],cbracketnum, line = self.li))
      ...
      if text[i] == "}" and isString == False and isNum == False:
        ...
        command_parts.append(Token(TO_RCBRACKET, text[i],cbracketnum, line = self.li))
        cbracketnum -= 1
        continue
      if text[i] == "(" and isString == False and isNum == False:
        bracketnum += 1
        ...
        command_parts.append(Token(TO_LBRACKET, text[i],bracketnum, line = self.li))
      ...
      if text[i] == ")" and isString == False and isNum == False:
        ...
        command_parts.append(Token(TO_RBRACKET, text[i],bracketnum, line = self.li))
        bracketnum -= 1
      ...
      if text[i] == '"' and isString == True:
        isString = False
        command_parts.append(Token(TO_STRING, current_text_list,cbracketnum, line = self.li))
        current_text_list = ""
        continue
        ...
        if isString == False and text[i] == " " and current_text_list != "": 
          command_parts.append(Token(TO_RT, current_text_list,cbracketnum, line = self.li))
          current_text_list = ""
